<template>
  ...
  <div class="link-container">
    <a class="link-one" @click="this.$emit('setPage','TextOpenAI')">Text</a>
  </div>
</div>
<div class="background-two link-container">
  <a class="link-two" @click="this.$emit('setPage','TextOpenAI')">Image</a>
</div>
<div class="background-three link-container">
  <a class="link-three" @click="this.$emit('setPage','TextOpenAI')">Sound</a>
</div>
    </div>
</template>
